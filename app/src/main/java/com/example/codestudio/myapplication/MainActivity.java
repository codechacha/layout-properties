    ...
    void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.example06:
                ...
                break;
            case R.id.example07:
                startActivity(new Intent(this, Example07.class));
                break;
            case R.id.example08:
                startActivity(new Intent(this, Example08.class));
                break;
            case R.id.example09:
                startActivity(new Intent(this, Example09.class));
                break;
            case R.id.example10:
                startActivity(new Intent(this, Example10.class));
                break;
            case R.id.example11:
                startActivity(new Intent(this, Example11.class));
                break;
        }
    }
}
